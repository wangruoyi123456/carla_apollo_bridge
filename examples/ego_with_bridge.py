...
class World(object):
    def __init__(self, carla_world, args):
        ...
        # self._actor_filter = 'vehicle.mini.cooperst'
        self._actor_filter = 'vehicle.bmw.isetta'
    ...
    def restart(self):
        ...
        if self.player is not None:
            ...
            self.destroy()
            # print('spawn_point_not*:', spawn_point)
        ...
        while self.player is None:
            ...
            #*******************************************************************************************
            point_self = spawn_points[6]
            #point_self.location.y +=6.0
            spawn_point = point_self
            print('spawn_point**:', spawn_point)
            #******************************************************************************************88
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
            print('******player.attributes:', self.player.attributes)
        ...
        '''***********************************do not need SensorManager(lidar and camera)**************************************************'''
